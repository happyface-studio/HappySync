...
| Deleted parent leaves orphaned children in the UI | No local FK constraint, or missing server child-tombstone trigger | Add real FK constraints (local cascade) and the server child-tombstone trigger. |
